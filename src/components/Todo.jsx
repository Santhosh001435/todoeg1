...
const deleteTodo = (id) => {
  ...
  <div className='w-[30-rem]'>
    <h1 className='text-lg my-2 font-medium
     text-amber-500'>To-Do List</h1>
     <div className='flex gap-2'>
        <div className='flex-1'>
            <input ref={inputRef} type='text' className='py-3 px-3 w-full text-sm
             border focus:outline-none focus:border-amber-500' placeholder='Add your task'/>
        </div>
        <button className='py-3 px-4 bg-blue-600
        text-white hover:bg-blue-700 text-sm font-medium rounded-sm border-none' onClick={addtask}>Add Task</button>
     </div>
